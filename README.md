...
사용하는 `font-family`의 이름은 `ChosunKg`입니다.
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/ChosunKg/subsets/ChosunKg-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/ChosunKg/subsets/ChosunKg-dynamic-subset.css');
```
...
```css
font-family: "ChosunKg", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
